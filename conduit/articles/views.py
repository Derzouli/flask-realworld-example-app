...
@article_bp.route('/api/articles/<slug>', methods=('PUT',))
@jwt_required(optional=False)
@use_kwargs(article_schema)
@marshal_with(article_schema)
...
@article_bp.route('/api/articles/<slug>', methods=('DELETE',))
@jwt_required(optional=False)
...
@article_bp.route('/api/articles/<slug>', methods=('GET',))
@jwt_required(optional=True)
@marshal_with(article_schema)
...
@article_bp.route('/api/articles/<slug>/favorite', methods=('POST',))
@jwt_required(optional=False)
@marshal_with(article_schema)
...
@article_bp.route('/api/articles/<slug>/favorite', methods=('DELETE',))
@jwt_required(optional=False)
@marshal_with(article_schema)
...
@article_bp.route('/api/articles/feed', methods=('GET',))
@jwt_required(optional=False)
...
@article_bp.route('/api/tags', methods=('GET',))
def get_tags():
...
@article_bp.route('/api/articles/<slug>/comments', methods=('GET',))
...
@article_bp.route('/api/articles/<slug>/comments', methods=('POST',))
@jwt_required(optional=False)
...
@article_bp.route('/api/articles/<slug>/comments/<cid>', methods=('DELETE',))
@jwt_required(optional=False)
