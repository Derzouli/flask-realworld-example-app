...
def register_blueprints(app):
    ...
    cors.init_app(user.views.user_bp, origins=origins)
    cors.init_app(profile.views.profile_bp, origins=origins)
    cors.init_app(articles.views.article_bp, origins=origins)

    app.register_blueprint(user.views.user_bp)
    app.register_blueprint(profile.views.profile_bp)
    app.register_blueprint(articles.views.article_bp)
